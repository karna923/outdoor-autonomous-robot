...
void IRAM_ATTR isr_enc_fl() {
    enc_count_fl++;
}
  
void IRAM_ATTR isr_enc_fr() {
    enc_count_fr++;
  }

void IRAM_ATTR isr_enc_ml() {
    enc_count_ml++;
  }

void IRAM_ATTR isr_enc_mr() {
    enc_count_mr++;
  }
